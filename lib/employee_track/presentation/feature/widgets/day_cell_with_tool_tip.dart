                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _tipRow(theme, Icons.schedule_rounded,
                          ...
                          LocaleDigits.format('$workedH${translation.of('analytics.h')} $workedM${translation.of('analytics.mi')}'), cs.primary),
                      const SizedBox(height: 6),
                      _tipRow(theme, Icons.free_breakfast_rounded,
                          translation.of('attendance.breaks'),
                          LocaleDigits.format(breakH > 0 ? '$breakH${translation.of('analytics.h')} $breakM${translation.of('analytics.mi')}' : '$breakM${translation.of('analytics.mi')}'),
                          cs.tertiary),
                      if (otSeconds > 0) ...[
                        const SizedBox(height: 6),
                        _tipRow(theme, Icons.more_time_outlined,
                            translation.of('analytics.ot'),
                            LocaleDigits.format('+${otH > 0 ? '$otH${translation.of('analytics.h')} ' : ''}$otM${translation.of('analytics.mi')}'),
                            Colors.orange),
                      ],
                      if (remainingSeconds > 0) ...[
                        ...
                        _tipRow(theme, Icons.hourglass_bottom_rounded,
                            ...
                            LocaleDigits.format('-${remainH > 0 ? '$remainH${translation.of('analytics.h')} ' : ''}$remainM${translation.of('analytics.mi')}'),
